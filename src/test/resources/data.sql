INSERT INTO TESTELSA."PUBLIC".GROUPS (GROUPNAME, MISSIONSCORES) values ('Kettupoppoo', 250);
INSERT INTO TESTELSA."PUBLIC".GROUPS (GROUPNAME, MISSIONSCORES) values ('Jermut', 20500);
INSERT INTO USERS (USERNAME, ROLE, POINTS, GROUPID, COMPLETEDMISSIONS, CONTACTPERSONUSERID, AUTHID) values ('Jermu', 'CHIEF', 2000, 1, ('Himmeli', 'Helpperi'), 1, 'auth0|5b87943afe13090f5ffd652b');
